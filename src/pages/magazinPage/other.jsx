...
//     return (
//         <div className="bg-[#323232] min-h-screen w-[100%] h-[100%]">
//             {/* <div className="max-w-7xl mx-auto w-[100%] h-[100%]"> */}
//             <div className=" h-20 rounded-md w-[100%] md:w-[95%] mx-auto bg-gray-800 flex justify-center items-center gap-2 md:gap-4">
